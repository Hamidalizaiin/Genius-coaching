...
const KeyPoints = () => {
  ...
  return (
    <section>
      <div className='flex flex-wrap py-4  gap-6 justify-center items-center'>
        {content.map((item, index) => (
          <div key={index} className=' flex flex-col gap-3 justify-center items-center text-center'>
            <div
